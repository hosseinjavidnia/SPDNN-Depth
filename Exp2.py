...
'''
    TrainValidationData = scipy.io.loadmat('TrainValidateAfterUDincluded.mat')

    TrainX = TrainValidationData['TrainDataX']
    TrainY = TrainValidationData['TrainDataAfterY']
    ValidationX = TrainValidationData['ValidateImX']
    ValidationY = TrainValidationData['ValidateImAfterY']
...
for epoch in range(num_epochs):
    ...
    if validationError < validationErrorBest:
            ...
            with open('netBestAttempt5After1.pickle' , 'wb') as handle:
    ...
    counter = counter + 1
    scipy.io.savemat('LossesAttempt5After1.mat', mdict={'TrainLoss': TRAINLOSS, 'ValidationLoss': VALIDATIONLOSS})
